...
function getDatabaseClient(settings) {
    switch (settings.adapter) {
        case 'mysql': return new MysqlClient_1.default(settings);
        case 'postgres': return new PostgresClient_1.default(settings);
        case 'postgresql': return new PostgresClient_1.default(settings);
        case 'sqlite3': return new Sqlite3Client_1.default(settings);
