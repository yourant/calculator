...
export const actions = {
    ...
    async actionRegisterUser(context: MainContext, payload: IUserProfileRegister) {
        try {
            ...
            commitSetNewUser(context, response.data);
            commitRemoveNotification(context, loadingNotification);
            commitAddNotification(context, { content: 'You have successfully Registered!', color: 'success' });
        } catch (error) {
            await dispatchCheckApiError(context, error);
        }
    },
